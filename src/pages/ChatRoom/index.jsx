...
const datas = [
  ...
  },
  {
    ...
    sex: '여자',
    contents:
      '가족들과 따뜻한 밥 한 끼를 먹으며, 그동안 못했던 이야기를 나누고 싶어요.',
    emojis: [
      { emoji: '😭', count: 20 },
      { emoji: '🍚', count: 26 },
      { emoji: '💗', count: 14 },
  ...
  },
  {
    ...
    sex: '여자',
    contents:
      '인생의 중요한 가르침을 주셨던 선생님께 감사 인사를 전하고 싶어요.',
    emojis: [
      { emoji: '💛', count: 26 },
      { emoji: '😊', count: 14 },
    ],
  },
  {
    ...
    sex: '여자',
    contents:
      '너무 빨리 떠나보낸 반려동물을 다시 만나서 더 많은 사랑을 주고 싶어요.',
    emojis: [
      { emoji: '😭', count: 26 },
      { emoji: '💙', count: 22 },
    ],
  ...
  },
  {
    ...
    sex: '남자',
    contents:
      '아리스토텔레스 선생님을 만나서 인생을 후회 없이 보내는 방법을 배우고 싶어요.',
    emojis: [
      { emoji: '👍', count: 26 },
      { emoji: '📜', count: 15 },
    ],
