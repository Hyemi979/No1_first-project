    ...
    return (
        ...
        <div {...rest} className={styles.wrap1}>
            <div className={styles.wrap2}>
                <div className={styles.wrap2_1}><p className={styles.SubTitle_02_Bold}>김맹구님과 챕의 성향 일치율</p><img src={information_circle} alt='information_circle' height='16px' width='16px'/></div>
