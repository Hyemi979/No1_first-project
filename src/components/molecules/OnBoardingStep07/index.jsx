  ...
  if (choice === 'optionA') {
    return ( 
      <div className={styles.container}>
        ...
        <img src={favorite_image07} alt="독서 스타일" className={styles.image} />
        </div>
        ...
        <div className={styles.buttonGroup}>
          <Favorite_selection_button onClick={() => handleNextStep('감성적인 문장 필사하면서 기록 공유')}>감성적인 문장 필사하면서 기록 공유</Favorite_selection_button>
          <Favorite_selection_button onClick={() => handleNextStep('깊은 뜻이 있는 문장 필사하면서 기록 공유')}>깊은 뜻이 있는 문장 필사하면서 기록 공유</Favorite_selection_button>
        </div>
      </div>
    );
  }
