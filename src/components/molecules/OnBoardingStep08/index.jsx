...
const OnBoardingStep08 = ({ nextStep }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <img src={favorite_image09} alt="독서 스타일" className={styles.image} />
      </div>
      ...
      <div className={styles.buttonGroup}>
        <Favorite_selection_button onClick={() => handleNextStep('책에 몰입 할 수 있는 곳 ')}>책에 몰입 할 수 있는 곳 </Favorite_selection_button>
        <Favorite_selection_button onClick={() => handleNextStep('감성있고, 커피가 맛있는 곳')}>감성있고, 커피가 맛있는 곳</Favorite_selection_button>
      </div>
    </div>
  );
};
