...
const InfoCard = ({ 
    ...
    return (
        <div {...rest} className={styles.wrap}>
            ...
            style={{ textAlign: 'left', lineHeight: 1.5, fontFamily:'bold' ,color: '#1A1A1A'}}
            >안내사항</Title>
            ...
            <div className={styles.icontext_container}>
                    ...
                    <IconText 
                    icon={calendarIcon}>{`${date}∙${date2}`}</IconText>

                    <IconText icon={peopleIcon}>{`${participants}∙${participants2}`}</IconText>
